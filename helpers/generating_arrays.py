...
def generate_ascending_array(minimum_number, maximum_number,size_of_array):
    return numpy.arange(minimum_number, maximum_number, size_of_array)


def generate_descending_array(minimum_number, maximum_number,size_of_array):
    return numpy.arange(minimum_number, maximum_number, size_of_array)[::-1]


def random_array(minimum_number, maximum_number,size_of_array):
    return numpy.random.randint(minimum_number, maximum_number, size_of_array)


def same_numbers_array(minimum_number, maximum_number,size_of_array):
